...
class Persona : NSObject {
    ...
    func obtenerFechaNac() -> Date {
        return self.fechaNac
    }
    
    func obtenerDomicilio() -> String {
        return self.domicilio
    }
    
    func obtenerCorreo() -> String {
        return self.correo
    }
...
class Contacto : Persona {
    ...
    func toString() -> String {
        return "Nombre: \(self.obtenerNombre()), Empresa: \(self.empresa), parentezco: \(self.parentesco)"
    }
...
class Agenda {
    ...
    func obtenerEventos() -> Array<Evento> {
        return self.eventos
    }
    ...
    static func obtenerAgenda() -> Agenda {
...
class Validador: NSObject {
    static func cambiarLbl(lbl : UILabel, color : UIColor, text : String) -> Void {
        lbl.text = text
        lbl.textColor = color
    }
    
    static func validar(lbl : UILabel, text : UITextField, textError : String, textSucces : String, regexp : String) -> Bool {
        let eval = text.text!
...
func construirAgenda()-> Agenda {
    ...
    var julio = Contacto(nombre: "Julio", fechaNac: "04/07/1978", domicilio: "Huautla, Hidalgo",
                         correo: "juls@man.do", empresa: "", parentesco: "padre", telefono: "12345675413")
